🛰️ Restful-Booker API Test Suite

Bu proje, Restful-Booker platformu üzerinde uçtan uca API test süreçlerini farklı araç setleri (Postman & Playwright) kullanarak doğrular. 
Proje, hem hızlı test koşumu (Postman) hem de ölçeklenebilir kod tabanlı (Playwright) yaklaşımları bir arada sunar.
...
•	Projenin ana dizininde aşağıdaki komutla testleri terminal üzerinden koşturabilirsiniz:
...
🏗️ 3.2. Playwright & TypeScript

Alternatif çözüm olarak aynı senaryolar Playwright kullanılarak kodlanmıştır.
