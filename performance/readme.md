...
Bu modül, sistemin dayanıklılığını, ölçeklenebilirliğini ve sınır değerlerini ölçmek amacıyla k6 kullanılarak geliştirilmiş kapsamlı bir performans analiz suite'idir. Testler, gerçek dünya trafik modellerini (Workload Modeling) simüle ederek sistemin "Breaking Point" ve "Recovery" kapasitesini ölçer.
