...
export declare class GrpcClient {
     ...
     */
    private getClientWorkerIdFromContext;
    /**
    ...
    testSessionEvent(data: Omit<TestSessionEventRequest, 'binSessionId'>): Promise<TestSessionEventResponse | undefined>;
    /**
     *
     * Send TestFrameworkEvent
     */
    testFrameworkEvent(data: Omit<TestFrameworkEventRequest, 'binSessionId'>): Promise<TestFrameworkEventResponse | undefined>;
    /**
     *
     * Send driverInitEvent
     */
    driverInitEvent(data: Omit<DriverInitRequest, 'binSessionId'>): Promise<DriverInitResponse>;
    logCreatedEvent(data: Omit<LogCreatedEventRequest, 'binSessionId'>): Promise<LogCreatedEventResponse | undefined>;
