...
var _TestRunner_instances, _TestRunner_child, _TestRunner_lastPayload, _TestRunner_baseDir, _TestRunner_buildFilters, _TestRunner_resolveLineNumber, _TestRunner_normaliseSpecFile, _TestRunner_getSpecCandidate, _TestRunner_extractSpecFromCallSource, _TestRunner_toFsPath, _TestRunner_resolveConfigPath, _TestRunner_findConfigFromSpec, _TestRunner_expandDefaultConfigsFor, _TestRunner_dedupeCandidates;
...
FRAMEWORK_FILTERS.nightwatch = ({ specArg, payload }) => {
    const filters = [];
    if (specArg) {
...
FRAMEWORK_FILTERS['nightwatch-cucumber'] = ({ payload }) => {
    const filters = [];
